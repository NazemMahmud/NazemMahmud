...
I am a **Senior Software Engineer**, having experience in Node (ExpressJs), Laravel, Python, React, Vue, Angular. I am always looking to collaborate on **Open Source Projects**
...
| Project | Description |
|---------|-------------|
| 🤖 **[AI Chatbot](https://github.com/NazemMahmud/ai-chatbot-be)** | Conversational AI chatbot built with LLM integration for intelligent responses, ensuring data privacy, chatbot plugin, etc. |
...
| 📊 **[Data Analytics Dashboard](https://github.com/NazemMahmud/analytics-dashboard)** | Real-time analytics dashboard with interactive charts and data visualization |
